...
DocumentType.create(name: "Adendum")
DocumentType.create(name: "Acta")
DocumentType.create(name: "Acuerdo")
DocumentType.create(name: "Avance")
DocumentType.create(name: "Certificación")
DocumentType.create(name: "Contrato")
DocumentType.create(name: "Convenio")
DocumentType.create(name: "Decreto")
DocumentType.create(name: "Fe de Erratas")
DocumentType.create(name: "Licitación")
DocumentType.create(name: "Marcas de Fábrica")
DocumentType.create(name: "Oficio")
DocumentType.create(name:"Otro")
DocumentType.create(name: "Reglamento")
DocumentType.create(name: "Resolución")
DocumentType.create(name: "Tratado")
