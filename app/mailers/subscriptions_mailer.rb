class SubscriptionsMailer < ApplicationMailer
  default from: 'TodoLegal <suscripciones@mg.todolegal.app>'
  ...
  def refer(referrer, email)
    ...
    mail(from: 'TodoLegal <suscripciones@mg.todolegal.app>', to: email, subject: 'Te han invitado a TodoLegal')
  end
  ...
  def welcome_pro_user user
    ...
    mail(from: 'TodoLegal <suscripciones@mg.todolegal.app>', to: user.email, subject: 'Cuenta Pro')
  end
end
