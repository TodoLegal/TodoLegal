...
include DocumentsHelper
  ...
  def perform(document, document_pdf_path, user)
    ...
    # end
    DocumentProcessingMailer.document_processing_complete(user, document_link).deliver
  end
  ...
  def run_slice_gazette_script document, document_pdf_path
    ...
    python_return_value = `python3 /home/carlosvilla/Github/TodoLegal-Repos/GazetteSlicer/slice_gazette.py #{ document_pdf_path } '#{ Rails.root.join("public", "gazettes") }' '#{document.id}'`
    begin
  ...
  def process_gazette document, document_pdf_path
    ...
    python_return_value = `python3 /home/carlosvilla/Github/TodoLegal-Repos/GazetteSlicer/process_gazette.py #{ document_pdf_path }`
    json_data = {}
    begin
