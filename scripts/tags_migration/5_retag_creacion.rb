...
old_tag.documents.each do |document|
  ...
  IssuerDocumentTag.create(document: document, tag: presidencia_tag)
end
old_tag.laws.each do |law|
  LawTag.create(law: law, tag: acuerdo_tag)
  IssuerLawTag.create(law: law, tag: presidencia_tag)
end
...
old_tag.documents.each do |document|
  DocumentTag.create(document: document, tag: decreto_tag)
  IssuerDocumentTag.create(document: document, tag: congreso_nacional_tag)
end
old_tag.laws.each do |law|
  LawTag.create(law: law, tag: decreto_tag)
  IssuerLawTag.create(law: law, tag: congreso_nacional_tag)
end

old_tag = Tag.find_by_name("Decreto Junta Militar")
old_tag.documents.each do |document|
  DocumentTag.create(document: document, tag: decreto_tag)
  IssuerDocumentTag.create(document: document, tag: junta_militar_tag)
end
old_tag.laws.each do |law|
  LawTag.create(law: law, tag: decreto_tag)
  IssuerLawTag.create(law: law, tag: junta_militar_tag)
end
...
old_tag.documents.each do |document|
  DocumentTag.create(document: document, tag: decreto_tag)
  IssuerDocumentTag.create(document: document, tag: asamblea_constituyente_tag)
end
old_tag.laws.each do |law|
  LawTag.create(law: law, tag: decreto_tag)
  IssuerLawTag.create(law: law, tag: asamblea_constituyente_tag)
end

old_tag = Tag.find_by_name("Resolución")
old_tag.documents.each do |document|
  DocumentTag.create(document: document, tag: resolucion_tag)
  IssuerDocumentTag.create(document: document, tag: cnbs_tag)
end
old_tag.laws.each do |law|
  LawTag.create(law: law, tag: resolucion_tag)
  IssuerLawTag.create(law: law, tag: cnbs_tag)
end
...
old_tag.documents.each do |document|
  DocumentTag.create(document: document, tag: acuerdo_tag)
  IssuerDocumentTag.create(document: document, tag: municipalidad_de_sps_tag)
end
old_tag.laws.each do |law|
  LawTag.create(law: law, tag: acuerdo_tag)
  IssuerLawTag.create(law: law, tag: municipalidad_de_sps_tag)
end