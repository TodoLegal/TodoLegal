...
ley_de_creditos_usurarios = Law.create({ name: 'Ley de creditos usuarios', creation_number: '100-62' })
...
ley_del_impuesto_sobre_ventas = Law.create({ name: 'Ley del Impuesto Sobre Ventas', creation_number: '24' })
...
LawTag.create({law_id: ley_especial_del_consejo_nacional_de_defensa.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_especial_para_la_depuracion_policial.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_especial_para_simplificacion_de_procedimientos_de_inversion_en_infraestructura_publica.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_especial_reguladora_de_proyectos_publicos_de_energia_renovable.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_general_de_la_industria_electrica.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_marco_de_politicas_publicas_en_materia_social.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_recauca.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_especial_de_fomento_para_las_organizaciones_no_gubernamentales_de_desarrollo.id, tag_id: tag_especiales_y_otras.id})
LawTag.create({law_id: ley_general_de_la_superintendencia_para_la_aplicacion_de_pruebas_de_evaluacion_de_confianza.id, tag_id: tag_especiales_y_otras.id})
LawTag.create({law_id: ley_especial_de_intervencion_de_comunicaciones_privadas.id, tag_id: tag_penal.id})
LawTag.create({law_id: ley_especial_para_el_ejercicio_del_sufragio_de_los_hondurenos_en_el_exterior.id, tag_id: tag_constitucional.id})
LawTag.create({law_id: ley_especial_que_regula_el_plesbicito_y_el_referendum.id, tag_id: tag_constitucional.id})

LawTag.create({law_id: codigo_del_notariado.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_constitutiva_de_las_zonas_de_exportacion.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_de_credito_publico.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_de_policia_y_convivencia_social.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_de_promocion_de_la_alianza_publico_privada.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_fundamental_de_educacion.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_general_de_mineria.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_monetaria.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_organica_de_la_marina_mercante.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_organica_de_la_policia_nacional_de_honduras.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_organica_de_la_procuradoria_general_de_la_republica.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_organica_del_comisionado_nacional_de_los_derechos_humanos.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_organica_del_presupuesto.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_organica_del_tribunal_superio_de_cuentas.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_para_la_proteccion_beneficios_y_regulacion_de_actividad_informal.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_para_optimizar_la_administracion_publica_mejorar_los_servicios_a_la_ciudadania.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_para_repatriacion_capitales.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_racionalizacion_de_combustibles_para_generacion_energia.id, tag_id: tag_administrativo.id})
LawTag.create({law_id: ley_general_del_ambiente.id, tag_id: tag_ambiental.id})
LawTag.create({law_id: ley_para_la_regulacion_de_las_operaciones_de_exploracion_y_explotacion_petrolera_y_minera.id, tag_id: tag_ambiental.id})
LawTag.create({law_id: ley_de_seguro_de_deposito_en_instituciones_del_sistema_financiero.id, tag_id: tag_bancario.id})
LawTag.create({law_id: ley_del_sistema_financiero.id, tag_id: tag_bancario.id})
LawTag.create({law_id: reglamento_del_regimen_de_obligaciones_medidas_de_control_y_deberes_de_instituciones_supervisadas.id, tag_id: tag_bancario.id})
LawTag.create({law_id: codigo_de_la_nines_y_la_adolescencia.id, tag_id: tag_civil.id})
LawTag.create({law_id: ley_de_amparo.id, tag_id: tag_constitucional.id})
LawTag.create({law_id: ley_marco_del_sistema_de_proteccion_social.id, tag_id: tag_especiales_y_otras.id})
LawTag.create({law_id: ley_para_la_promocion_y_fomento_del_desarrollo_cientifico_tecnologico_y_la_innovacion.id, tag_id: tag_especiales_y_otras.id})
LawTag.create({law_id: ley_especialidad_para_maternidad_y_paternidad_responsable.id, tag_id: tag_familia.id})
LawTag.create({law_id: ley_de_la_carrera_judicial.id, tag_id: tag_judicial.id})
LawTag.create({law_id: ley_para_el_financiamiento_de_los_ajustes_salariales.id, tag_id: tag_laboral.id})
LawTag.create({law_id: ley_para_la_defensa_y_promocion_de_la_competencia.id, tag_id: tag_mercantil.id})
LawTag.create({law_id: ley_para_la_promocion_y_de_proteccion_de_inversiones.id, tag_id: tag_mercantil.id})
LawTag.create({law_id: ley_para_produccion_y_consumo_de_biocombustible.id, tag_id: tag_mercantil.id})
LawTag.create({law_id: ley_sobre_comercializacion_y_procesamiento_de_materiales_metalicos.id, tag_id: tag_mercantil.id})
LawTag.create({law_id: ley_sobre_comercio_electronico.id, tag_id: tag_mercantil.id})
LawTag.create({law_id: ley_sobre_firmas_electronicas.id, tag_id: tag_mercantil.id})
LawTag.create({law_id: reglamento_de_la_ley_de_apoyo_a_la_micro_y_pequena_empresa.id, tag_id: tag_mercantil.id})
LawTag.create({law_id: ley_contra_el_delito_de_lavado_de_activos.id, tag_id: tag_penal.id})
LawTag.create({law_id: ley_contra_el_enriquecimiento_ilicito_de_los_servidores_publicos.id, tag_id: tag_penal.id})
LawTag.create({law_id: ley_contra_el_financiamiento_del_terrorismo.id, tag_id: tag_penal.id})
LawTag.create({law_id: ley_contra_la_violencia_domestica.id, tag_id: tag_penal.id})
LawTag.create({law_id: ley_de_indulto.id, tag_id: tag_penal.id})
LawTag.create({law_id: ley_del_ministerio_publico.id, tag_id: tag_penal.id})
LawTag.create({law_id: ley_especial_contra_el_lavado_de_activos.id, tag_id: tag_penal.id})
...
LawTag.create({law_id: ley_especial_del_consejo_nacional_de_defensa.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_especial_para_la_depuracion_policial.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_especial_para_simplificacion_de_procedimientos_de_inversion_en_infraestructura_publica.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_especial_reguladora_de_proyectos_publicos_de_energia_renovable.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_general_de_la_industria_electrica.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_marco_de_politicas_publicas_en_materia_social.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_recauca.id, tag_id: tag_tratado_internacional.id})
LawTag.create({law_id: ley_especial_de_fomento_para_las_organizaciones_no_gubernamentales_de_desarrollo.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_general_de_la_superintendencia_para_la_aplicacion_de_pruebas_de_evaluacion_de_confianza.id, tag_id:tag_decreto_legislativo.id})
LawTag.create({law_id: ley_especial_de_intervencion_de_comunicaciones_privadas.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_especial_para_el_ejercicio_del_sufragio_de_los_hondurenos_en_el_exterior.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_especial_que_regula_el_plesbicito_y_el_referendum.id, tag_id: tag_decreto_legislativo.id})

LawTag.create({law_id: codigo_del_notariado.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_constitutiva_de_las_zonas_de_exportacion.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_de_credito_publico.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_de_policia_y_convivencia_social.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_de_promocion_de_la_alianza_publico_privada.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_fundamental_de_educacion.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_general_de_mineria.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_monetaria.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_organica_de_la_marina_mercante.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_organica_de_la_policia_nacional_de_honduras.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_organica_de_la_procuradoria_general_de_la_republica.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_organica_del_comisionado_nacional_de_los_derechos_humanos.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_organica_del_presupuesto.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_organica_del_tribunal_superio_de_cuentas.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_para_la_proteccion_beneficios_y_regulacion_de_actividad_informal.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_para_optimizar_la_administracion_publica_mejorar_los_servicios_a_la_ciudadania.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_para_repatriacion_capitales.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_racionalizacion_de_combustibles_para_generacion_energia.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_general_del_ambiente.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_para_la_regulacion_de_las_operaciones_de_exploracion_y_explotacion_petrolera_y_minera.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_de_seguro_de_deposito_en_instituciones_del_sistema_financiero.id, tag_id: tag_decreto_ejecutivo.id})
LawTag.create({law_id: ley_del_sistema_financiero.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: reglamento_del_regimen_de_obligaciones_medidas_de_control_y_deberes_de_instituciones_supervisadas.id, tag_id: tag_resolucion.id})
LawTag.create({law_id: codigo_de_la_nines_y_la_adolescencia.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_de_amparo.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_marco_del_sistema_de_proteccion_social.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_para_la_promocion_y_fomento_del_desarrollo_cientifico_tecnologico_y_la_innovacion.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_especialidad_para_maternidad_y_paternidad_responsable.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_de_la_carrera_judicial.id, tag_id: tag_decreto_ejecutivo.id})
LawTag.create({law_id: ley_para_el_financiamiento_de_los_ajustes_salariales.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_para_la_defensa_y_promocion_de_la_competencia.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_para_la_promocion_y_de_proteccion_de_inversiones.id, tag_id: tag_acuerdo_ejecutivo.id})
LawTag.create({law_id: ley_para_produccion_y_consumo_de_biocombustible.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_sobre_comercializacion_y_procesamiento_de_materiales_metalicos.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_sobre_comercio_electronico.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_sobre_firmas_electronicas.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: reglamento_de_la_ley_de_apoyo_a_la_micro_y_pequena_empresa.id, tag_id: tag_acuerdo_ejecutivo.id})
LawTag.create({law_id: ley_contra_el_delito_de_lavado_de_activos.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_contra_el_enriquecimiento_ilicito_de_los_servidores_publicos.id, tag_id: tag_decreto_ejecutivo.id})
LawTag.create({law_id: ley_contra_el_financiamiento_del_terrorismo.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_contra_la_violencia_domestica.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_de_indulto.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_del_ministerio_publico.id, tag_id: tag_decreto_legislativo.id})
LawTag.create({law_id: ley_especial_contra_el_lavado_de_activos.id, tag_id: tag_decreto_legislativo.id})
