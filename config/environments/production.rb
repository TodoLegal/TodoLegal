...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "TodoLegal_production"
  ...
  #MAILER_HOST currently not working, so we use the same fallback as in MultiAppDeviseMailer#mailer_host
